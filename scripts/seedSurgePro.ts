...
const PROJECT_NAME = "Surge";

const PRODUCT_IDENTIFIER = "surge_pro_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "surge_pro_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "Surge Pro Monthly";
const PRODUCT_USER_FACING_TITLE = "Surge Pro";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "Surge iOS";
const APP_STORE_BUNDLE_ID = "app.replit.surge";
const PLAY_STORE_APP_NAME = "Surge Android";
const PLAY_STORE_PACKAGE_NAME = "app.replit.surge";

const ENTITLEMENT_IDENTIFIER = "surge_pro";
const ENTITLEMENT_DISPLAY_NAME = "Surge Pro Access";
...
async function seedSurgePro() {
  ...
  console.log("\n====================");
  console.log("Surge Pro RevenueCat setup complete!");
...
seedSurgePro().catch(console.error);
